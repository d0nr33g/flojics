    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 p-5 shadow-sm bg-white">
                <h4 class="mb-4 blue-text">Edit Booking :</h4>
                @if($errors->any())
                    <ul>
                ...
                <form action="/doctor/{{$doctor->id}}/booking" method="POST" class="ps-4 flo-create">
                    ...
                    <input type="date" class="form-control" name="date" required value="{{$booking->date}}">

                    <div class="mb-2">
                        <i class="fa-solid fa-clock"></i>
                        <label>Time</label>
                    </div>
                    <input type="time" name="time" class="form-control" required value="{{$booking->time}}">
